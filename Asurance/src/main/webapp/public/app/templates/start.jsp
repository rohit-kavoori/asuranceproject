...
<div class="container">
	<div class="row" >
		...
		<div
			...
			<%if(failure != null) {%><div id="wrongCredential" style="color:white; font-size:20px;"><%=failure %></div>
					<%session.invalidate();} %>
				...
				<div class="row">
					<div class="col-xs-12 col-md-12">
						<input  type="submit" value="Continue"
							 class="btn btn-primary btn-block btn-lg" ng-click="quoteForm(model)" tabindex="8" >
					</div>
				</div>
			</form>
		</div>
