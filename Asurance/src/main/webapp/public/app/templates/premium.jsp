...
<div class="container" style="
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="radio">
							<label><input type="radio" name="optradio">$50k/$100k/$50k</label>
							<span style="margin-left: 220px; color: #ffb84d"><strong>Current</strong></span>
						</div>

						<hr class="style15">

						<div class="radio">
							<label><input type="radio" name="optradio">$100/$300k/$50k</label>
							<span style="margin-left: 240px;">+$84</span>
						</div>
						...
						<div class="radio">
							<label><input type="radio" name="optradio">$250/$500k/$100k</label>
							<span style="margin-left: 230px;">+$197</span>
						</div>

						<hr class="style15">

						<div class="radio">
							<label><input type="radio" name="optradio">$100k
								CSL</label> <span style="margin-left: 280px;">+$27</span>
						</div>

						<hr class="style15">

						<div class="radio">
							<label><input type="radio" name="optradio">$300k
								CSL</label> <span style="margin-left: 280px;">+$160</span>
						</div>

						<hr class="style15">

						<div class="radio">
							<label><input type="radio" name="optradio">$500k
								CSL</label> <span style="margin-left: 280px;">+$224</span>
						</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>We pay for medical expenses and in some cases other
							...
							when you’re in an accident caused by a driver who has no
							insurance.</p>
						<br>
						<hr class="style13">
						<span><strong>Coverage</strong></span> <span
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>We pay for medical expenses and in some cases other
							benefits up to the limit you choose, for you and your passengers,
							when you’re in an accident caused by a driver who doesn’t
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>We pay for medical expenses, lost wages, and, in some
							...
							an accident, no matter who’s at fault.</p>
						<br>
						<hr class="style13">
						<span><strong>Coverage</strong></span> <span
							style="color: grey; margin-left: 200px;"><strong>Change
	...
	<hr class="colorgraph">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<input type="submit" class="btn btn-md btn-primary" id="goToSummary" value="Save & Continue">
			</div>
		</div>
