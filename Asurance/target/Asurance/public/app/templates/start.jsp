<div class="container" style="margin-top: 150px">
  ...
  <form name="startPage" ng-controller="startPageCtrl" novalidate method="post" action="getVehicles">
    ...
    <div class=" form-group row ">
      ...
      <div class="col-sm-4"><input type="text" class="form-control" ng-model="model.lastName" name="lastName" placeholder="Last Name" required /><span class="text-error" ng-show="startPage.submitted && startPage.lastName.$invalid" ng-style="errorField">*</span></div>
      <div class="col-sm-2 ">
      ...
      <div class="form-group row">
        <div class="col-sm-4 has-feedback "><input type="text" class="form-control" ng-model="model.address1" name="addressLine1" placeholder="Mailing Address" required /><span class="text-error" ng-show="startPage.submitted && startPage.address1.$invalid" ng-style="errorField">*</span><i class="form-control-feedback glyphicon glyphicon-home"></i></div>
        <div class="col-sm-3 "><input type="text" class="form-control" name="addressLine2" placeholder="Apt./Unit #"/></div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-2 " ng-controller="stateController">
          <select class="form-control"   ng-model="model.address3" name="state" id="state" style="border-radius: 4px;border: solid 3px #cbc9c9;background-color: #fcf8e3"  ng-model = "selectedState"   required >
        ...
        <div class="form-group row">
         <!--  <div class="col-sm-2 "> <label for="dob" style="margin-top:10px">Date of Birth</label></div> -->
          <div class="col-sm-3 "><input type="date" class="form-control" ng-model="model.dob" name="dateOfBirth" required /><span class="text-error" ng-show="startPage.submitted && startPage.dob.$invalid" ng-style="errorField">*</span></div>
        </div>
        <div class="form-group row">
